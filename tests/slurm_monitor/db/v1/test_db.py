...
async def test_memory_status(test_db, number_of_nodes, number_of_samples):
    for i in range(0, number_of_nodes):
        ...
        status = await test_db.get_memory_status(
            node=nodename, start_time_in_s=start_epoch, end_time_in_s=end_epoch, resolution_in_s=resolution_in_s
        )
...
async def test_memory_status_timeseries_list(test_db, number_of_nodes, number_of_samples):
    ...
    status = await test_db.get_memory_status_timeseries_list(nodes=nodes, resolution_in_s=resolution_in_s)
...
async def test_cpu_status_timeseries_list(test_db, number_of_nodes, number_of_samples):
    ...
    status = await test_db.get_cpu_status_timeseries_list(nodes=nodes, resolution_in_s=resolution_in_s)
...
async def test_gpu_status_timeseries_list(test_db, number_of_nodes, number_of_gpus, number_of_samples):
    ...
    status = await test_db.get_gpu_status_timeseries_list(nodes=nodes, resolution_in_s=resolution_in_s)
