...
@pytest.mark.parametrize(
    ...
    [
        [
            "billing=12,cpu=6,gres/gpu=1,mem=48G,node=1",
            {"billing": 12, "cpu": 6, "gpu": 1, "mem": 48 * 1024**3, "node": 1},
        ],
        [
            "billing=20.3,cpu=20,gres/gpu:rtx30=1,gres/gpu=1,mem=50000M,node=1",
            {
                "billing": 20.3,
                "cpu": 20,
                "gpu:rtx30": 1,
        ...
        [
            "billing=2.0,cpu=4,gres/gpu=3,mem=50000K,node=2",
            {"billing": 2.0, "cpu": 4, "gpu": 3, "mem": 50000 * 1024, "node": 2},
        ],
        [
            "billing=1,cpu=2,gres/gpu=1,mem=5T,node=1",
            {"billing": 1, "cpu": 2, "gpu": 1, "mem": 5 * 1024**4, "node": 1},
        ],
        [
            "billing=1,cpu=2,gres/gpu=1,mem=5P,node=1",
            {"billing": 1, "cpu": 2, "gpu": 1, "mem": 5 * 1024**5, "node": 1},
        ],
        [
            "billing=1,cpuasdfasdfas,gasdfa",
            {"billing": 1, "cpu": 0, "gpu": 0, "mem": 0, "node": 0},
        ],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            "n[001-003,056].ex3,gh001.ex3",
            ["n001.ex3", "n002.ex3", "n003.ex3", "n056.ex3", "gh001.ex3"],
        ],
        [
            "n[001-003,056].ex3,gh001.ex3.simula.no",
            ["n001.ex3", "n002.ex3", "n003.ex3", "n056.ex3", "gh001.ex3.simula.no"],
        ],
    ],
)
def test_expand_node_names(names, nodes):
    assert sorted(Slurm.expand_node_names(names)) == sorted(nodes)
