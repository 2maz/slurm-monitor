...
class MainParser(ArgumentParser):
    def __init__(self, **kwargs):
        ...
        self.add_argument(
            "--env-file", type=str, default=".env", help="Set the env-file"
        )
...
def run():
    ...
    main_parser.attach_subcommand_parser(
        subcommand="query", help="Query the database", parser_klass=QueryParser
    )

    main_parser.attach_subcommand_parser(
        subcommand="restapi", help="Start the restapi", parser_klass=RestapiParser
    )
    ...
    main_parser.attach_subcommand_parser(
        subcommand="test", help="Create a test database", parser_klass=TestParser
    )
